    ...
    <div className="flex flex-col flex-1 min-h-0">
      <div className="flex-1 min-h-0 overflow-y-auto">
        <div className="pt-2 pr-1">
          ...
          {/* when all-messages got load and we click on any message
           tht particular message holds a particular fragment (see the prisma schema)
          that will be loaded onto the right side of the screen

          and this is what fragment is .. it conatins the code, url and other things per message
           */}
